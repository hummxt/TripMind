            ...
            const res = await fetch("/api/generate-plan", {
                ...
                body: JSON.stringify({
                    formData: {
                        ...
                        travelClass: "economy",
                        budgetPreference: formData.budget || "medium",
                        season: "any",
                        interests: [formData.interest || "Sightseeing"],
                        foodPreference: "mix",
                        mealsPerDay: "3",
                        specialRequests: ""
                    },
    ...
    return (
        <div className="min-h-screen flex flex-col relative">
            ...
            <main className="flex-grow max-w-7xl mx-auto w-full pt-32 pb-20 px-6 flex flex-col items-center relative z-10">
                <div className={`absolute top-0 right-0 w-[50%] h-[50%] bg-primary/5 blur-[200px] pointer-events-none`} />
                    ...
                    {!plan && !isGenerating && (
                        <div className="space-y-16 animate-in fade-in slide-in-from-bottom-10 duration-700">
                            ...
                            <div className="flex justify-center">
                                <TripPlannerForm onGenerate={generatePlan} />
                            </div>
                        </div>
                    )}

                    {isGenerating && (
                        <div className="flex flex-col items-center gap-10 py-32 text-center animate-in zoom-in-95 duration-500">
                            ...
                            <div className="space-y-4">
                                <h3 className="text-5xl font-black tracking-tighter gradient-text">{t("analyzing")}</h3>
                        ...
                        <div className="animate-in zoom-in-95 duration-700 w-full flex flex-col items-center">
                            <div className="mb-12 space-y-3 text-center">
                                ...
                                <h2 className="text-4xl md:text-5xl font-black tracking-[-0.03em]">
                                    {language === "en" ? "Your Plan is Ready" : language === "az" ? "Planınız Hazırdır" : "Ваш план готов"}
                                </h2>
                                <p className="text-white/50 dark:text-neutral-500 font-bold tracking-widest uppercase text-xs">Generated by TripMind Intelligence</p>
                            </div>
